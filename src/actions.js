...
// when we start loading fetching from the api
export const GET_PRODUCTS_BEGIN = 'GET_PRODUCTS_BEGIN'
// when we have successfully fetched the data from the api
export const GET_PRODUCTS_SUCCESS = 'GET_PRODUCTS_SUCCESS'
// when we COULD NOT successfully fetch the data from the api
